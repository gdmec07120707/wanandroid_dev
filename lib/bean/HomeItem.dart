class HomeItem {
  ...
  HomeItem.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new HomeItemData.fromJson(json['data']) : null;
...
class HomeItemData {
  ...
  HomeItemData({this.over, this.pageCount, this.total, this.curPage, this.offset, this.size, this.datas});
  ...
  HomeItemData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datas'] != null) {
      ...
      (json['datas'] as List).forEach((v) { datas.add(new HomeItemDataData.fromJson(v)); });
    }
  }
...
class HomeItemDataData {
  ...
  HomeItemDataData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['tags'] != null) {
      ...
      (json['tags'] as List).forEach((v) { tags.add(new HomeItemDataDatasTag.fromJson(v)); });
    }
